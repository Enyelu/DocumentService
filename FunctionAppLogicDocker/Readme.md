...
WORKDIR /src
COPY ["FunctionAppLogicDocker.csproj", "FunctionAppLogicDocker/"]
RUN dotnet restore "FunctionAppLogicDocker/FunctionAppLogicDocker.csproj"

WORKDIR "/src/FunctionAppLogicDocker"
COPY . .
RUN dotnet build "FunctionAppLogicDocker.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "FunctionAppLogicDocker.csproj" \
...
Execute unit tests
```
    cd "FunctionAppLogicDocker/test/FunctionAppLogicDocker.Tests"
    dotnet test
```

Deploy application
```
    cd "FunctionAppLogicDocker/src/FunctionAppLogicDocker"
